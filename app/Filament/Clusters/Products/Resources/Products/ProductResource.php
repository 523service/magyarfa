...
use App\Filament\Clusters\Products\Resources\Products\RelationManagers\CompetitorLinksRelationManager;
use App\Filament\Clusters\Products\Resources\Products\RelationManagers\PriceComponentsRelationManager;
...
class ProductResource extends Resource
{
    ...
    public static function getNavigationBadge(): ?string
    {
        ...
        return (string) $modelClass::where('is_visible', 1)->count();
    }
}
