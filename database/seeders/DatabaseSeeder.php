...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Units
        $this->command->warn(PHP_EOL . 'Creating shop units...');
        $this->call(UnitSeeder::class);
        $this->command->info('Shop units created.');

        // Attributes
        $this->command->warn(PHP_EOL . 'Creating shop attributes...');
        $this->call(AttributeSeeder::class);
        $this->command->info('Shop attributes created.');
